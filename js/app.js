...
(function () {
  ...
  function renderDependency() {
    ...
    $("dep-body").innerHTML =
      ...
      + "</div>"
      + '<p class="note dep-say" style="margin-bottom:16px">'
      +   "<span>その1人が異動や退職で抜けると、そのつながりは組織から失われます。</span>"
      +   "<span>名刺は残っても、「誰に頼めば話が通るか」が分からなくなります。</span>"
      + "</p>"
      ...
      + '<p class="note dep-say" style="margin-top:12px">'
      +   "<span>棒の長さは、名刺を交換した人数です。</span>"
      +   "<span>朱色の部分は、社内でその人しかつながっていない相手を表します。</span>"
      +   (d.none
          ? "<span>なお、名刺を登録した人が分からない人物が " + d.none + " 名います。</span>"
          : "")
      + "</p>";
  }
